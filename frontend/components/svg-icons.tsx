export const ShowPassord = ({ width = 20, height = 20 }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const HidePassword = ({ width = 20, height = 20 }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 28 28"
...
const RightArrow = ({ width = 20, height = 20, stroke = "#000" }) => (
  <svg
    width={width}
    height={height}
    stroke={stroke}
